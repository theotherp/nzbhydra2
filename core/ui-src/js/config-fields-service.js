            ...
            },
            {
              ...
              templateOptions: {
                ...
                options: [{
                  ...
                  {
                    label: 'Indexer scheduler',
                    id: 'SCHEDULER'
                  },
                  {
                    label: 'User agent mapping',
                    id: 'USER_AGENT'
                  },
                  {
                    label: 'Download status updating',
                    id: 'DOWNLOAD_STATUS_UPDATE'
                  },
                  {
                    label: 'URL calculation',
                    id: 'URL_CALCULATION'
                  },
                  {
                    label: 'HTTP',
            ...
            fields: [{
              ...
              },
              {
                ...
                templateOptions: {
                  ...
                  options: [{
                      name: 'For all searches',
                      value: 'BOTH'
                    },
                    {
                      name: 'For internal searches',
                      value: 'INTERNAL'
                    },
                    {
                      name: 'For API searches',
                      value: 'API'
                    },
                    {
                      name: 'Never',
...
function getIndexerBoxFields(model, parentModel, isInitial, injector, CategoriesService) {
  ...
  fieldset.push({
    ...
    templateOptions: {
      label: 'Enable for...',
      options: [{
          name: 'Internal searches only',
          value: 'INTERNAL'
        },
        {
          name: 'API searches only',
          value: 'API'
        },
        {
          name: 'Internal and API searches',
          value: 'BOTH'
        }
      ]
    }
