...
//CREATE INDEX INDEXERAPIACC_INDID_index ON INDEXERAPIACCESS (INDEXER_ID); Created automatically by H2
CREATE INDEX INDEXERAPIACC_TIME_index ON INDEXERAPIACCESS (TIME);
CREATE INDEX INDEXERAPIACC_INDID_TIME_index ON INDEXERAPIACCESS (INDEXER_ID, TIME);
