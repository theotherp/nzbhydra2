...
var nzbhydraapp = angular.module('nzbhydraApp', ['angular-loading-bar', 'cgBusy', 'ui.bootstrap', 'ipCookie', 'angular-growl',
    ...
    'templates', 'base64', 'duScroll', 'colorpicker.module', 'bm.uiTour']);
...
function dropdownMultiselectDirective() {
    return {
        ...
        controller: ["$scope", "$element", "$filter", "$document", "$timeout", "$window", function dropdownMultiselectController($scope, $element, $filter, $document, $timeout, $window) {
...
function copyLinksButton() {
    controller.$inject = ["$scope", "$window", "growl"];
    return {
...
SearchController.$inject = ["$scope", "$http", "$stateParams", "$state", "$uibModal", "$timeout", "$sce", "growl", "SearchService", "focus", "ConfigService", "HydraAuthService", "CategoriesService", "$element", "SearchHistoryService", "GuidedTourService", "uiTourService"];
...
SavedSearchesController.$inject = ["$scope", "$http", "$sce", "$filter", "SearchHistoryService", "$httpParamSerializer", "$window"];
angular
    .module('nzbhydraApp')
...
GuidedTourService.$inject = ["$http", "$timeout", "$q", "$rootScope", "$sce", "$state", "uiTourService", "ConfigService", "CategoriesService", "growl"];
angular
    .module('nzbhydraApp')
