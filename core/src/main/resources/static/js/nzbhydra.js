    ...
    .config(["formlyConfigProvider", function config(formlyConfigProvider) {
        ...
        formlyConfigProvider.setType({
            ...
            controller: function ($scope, $uibModal, growl, CategoriesService) {
                ...
                $scope.presets = getIndexerPresets();
                ...
                function _showBox(model, parentModel, isInitial, callback) {
                    var modalInstance = $uibModal.open({
                        ...
                        resolve: {
                            ...
                            fields: function () {
                                return getIndexerBoxFields(model, parentModel, isInitial, angular.injector(), CategoriesService);
                            },
                            isInitial: function () {
                                return isInitial
                            },
                ...
                $scope.addEntry = function (entriesCollection, preset) {
                    if (checkAddingAllowed(entriesCollection, preset)) {
...
angular.module('nzbhydraApp').controller('IndexerConfigBoxInstanceController', ["$scope", "$q", "$uibModalInstance", "$http", "model", "fields", "isInitial", "parentModel", "data", "growl", "IndexerCheckBeforeCloseService", function ($scope, $q, $uibModalInstance, $http, model, fields, isInitial, parentModel, data, growl, IndexerCheckBeforeCloseService) {
