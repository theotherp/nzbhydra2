...
package org.nzbhydra.config.yaml;
 ...
 */
@Order(-1000)
class HydraOriginTrackedYamlLoader extends HydraYamlProcessor {

	private final Resource resource;

	HydraOriginTrackedYamlLoader(Resource resource) {
	...
	private class OriginTrackingConstructor extends Constructor {
		...
		private Origin getOrigin(Node node) {
			...
			return new TextResourceOrigin(HydraOriginTrackedYamlLoader.this.resource,
					location);
		}
