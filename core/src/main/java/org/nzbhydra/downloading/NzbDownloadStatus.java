...
public enum NzbDownloadStatus {
    ...
    private final NzbDownloadStatus[] canUpdate;


    NzbDownloadStatus(NzbDownloadStatus... canUpdate) {
        this.canUpdate = canUpdate;
    }

    boolean canUpdate(NzbDownloadStatus status) {
