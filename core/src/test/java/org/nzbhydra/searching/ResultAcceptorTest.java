...
public class ResultAcceptorTest {
    ...
    public void shouldCheckForForbiddenPoster() {
        when(searchingConfig.getForbiddenPosters()).thenReturn(Sets.newSet("spammer"));
        ...
        when(searchingConfig.getForbiddenPosters()).thenReturn(Sets.newSet());
        assertTrue(testee.checkForForbiddenPoster(HashMultiset.create(), item));
    }

    @Test
    public void shouldCheckForForbiddenGroup() {
        when(searchingConfig.getForbiddenGroups()).thenReturn(Sets.newSet("spammergroup"));
        ...
        when(searchingConfig.getForbiddenGroups()).thenReturn(Sets.newSet());
        assertTrue(testee.checkForForbiddenGroup(HashMultiset.create(), item));
    }
