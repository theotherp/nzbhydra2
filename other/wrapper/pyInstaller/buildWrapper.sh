...
cp dist/linux/NZBHydra2 ../../../../releases/linux-release/binaries/v2/
cd ../
...
cp dist/windows/NZBHydra2.exe ../../../../releases/windows-release/binaries/v2/
cd ../
...
docker run -v "$(pwd):/src/" cdrx/pyinstaller-windows
cp dist/windows/NZBHydra2\ Console.exe ../../../../releases/windows-release/binaries/v2/
cd ../
