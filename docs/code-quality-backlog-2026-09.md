...
| 23 | Split `SearchResults.tsx` (2783 lines) at verified seams: `ResultsAlerts` (1243-1319), `ResultsToolbar` (1320-1702), `ResultsTable` (1745-2588), `ResultsPagingFooter` (2601-2632), plus `useResultDisplayChoices` and `useResultSelection` hooks. | `ui-react/src/features/search/results/SearchResults.tsx` | in progress |
