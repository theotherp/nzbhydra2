...
| JVM package, root base             | repository root   | `python3 misc/run_gui_systemtest.py --runtime local -- tests/shell-selector.spec.ts tests/news.spec.ts`                                                                                                                                                                                                                                            | Passed: 2 Playwright tests against the built executable JAR.                                                                                                                                                                                                                                                         |
