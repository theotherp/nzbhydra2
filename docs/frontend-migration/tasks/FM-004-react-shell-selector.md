...
| repository root   | `python3 misc/run_gui_systemtest.py --runtime local -- tests/shell-selector.spec.ts`                                                | Passed: 1 Playwright test; also verified Maven packages assets to `core/target/classes/static/react`.                                        |
