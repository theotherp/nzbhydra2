...
Feature IDs: F-CONFIG-EXTERNAL-TOOLS Component IDs: C-CONFIG-FIELDS, C-CONFIG-FORM, C-DIALOG-SERVICE, C-TOAST-SERVICE API IDs: API-CONFIG-EXTERNAL-CONNECTION, API-CONFIG-EXTERNAL-CONFIGURE, API-CONFIG-EXTERNAL-SYNC, API-CONFIG-PUT Depends on: None Blocks: None
