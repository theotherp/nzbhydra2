...
- Search criteria, including media and indexer selection; recent-search refill and repeat; live progress; and result sorting, filtering, grouping (with legacy's one-time TV-episode grouping help, shown once per user), paging, rejection-reason breakdowns, supported download actions, display preferences, and saving executed searches.
