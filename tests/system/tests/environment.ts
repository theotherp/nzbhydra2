export class TestEnvironment {
    ...
    readonly radarrExternalUrl = process.env.RADARR_EXTERNAL_URL || "http://127.0.0.1:7878";
    readonly radarrApiKey = process.env.RADARR_API_KEY || "system-test-api-key-12345";
    readonly sonarrPresetUrl = process.env.SONARR_PRESET_URL || "http://localhost:18989";
    readonly sonarrInternalUrl = process.env.SONARR_INTERNAL_URL || "http://sonarr:8989";
    readonly sonarrExternalUrl = process.env.SONARR_EXTERNAL_URL || "http://127.0.0.1:18989";
