...
echo Writing file from remote server to ${PWD}/releases/linux-arm64-release/include/
scp build@141.147.54.141:/home/build/nzbhydra2/core/target/core ${PWD}/releases/linux-arm64-release/include/
chmod +x ${PWD}/releases/linux-arm64-release/include/core
