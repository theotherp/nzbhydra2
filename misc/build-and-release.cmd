...
if not exist "%~dp0..\releases\linux-release\binaries\v2\nzbhydra2" (
    echo %~dp0..\releases\linux-release\binaries\v2\nzbhydra2 does not exist
    goto error
)
if not exist "%~dp0..\releases\binaries\v2\nzbhydra2.exe" (
    echo %~dp0..\releases\binaries\v2\nzbhydra2.exe does not exist
    goto error
)
