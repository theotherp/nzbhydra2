...
For ADR-0006 visual work, audit the scoped feature visual record, deterministic setup, named viewport geometry, evidence paths, optional narrow snapshots, and variance disposition. A reviewer may validate a proposal but must never supply or
infer human baseline/variance acceptance; visual evidence is independent of behavioral and accessibility gates.
