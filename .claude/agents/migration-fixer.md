...
When a required correction needs an unresolved fundamental choice, report `BLOCKED: DECISION REQUIRED` with the decision question, repository evidence, viable options, affected task/registry IDs, and recommendation. Do not choose an
