...
Your only permitted file writes are creating or editing files matching `docs/frontend-migration/decisions/ADR-*.md`. Do not write, edit, or otherwise modify any other file.
